    ...
    return (
        <div className="container mx-auto py-10 px-8">
            <div className="flex flex-row text-center items-center">
                <img className="w-12 h-12 rounded-full" src={Ellipse12} alt="" />
                <div className="flex flex-col ml-2 items-start">
                    <h3 className='text-[black] text-[18px] font-medium'>Kim Lien</h3>
                    <h4 className='text-[14px] font-normal'>3 ngày trước</h4>
                </div>
            </div>
            <h2 className='text-[#003663] text-[40px] font-semibold my-4'>Time and motivation</h2>
            <p className='text-[18px] font-light tracking-wide leading-8'>Maybe it's been a long time since I've touched a thing called "timetable". Or more rustic, people often call it "daily schedule", and for students, it is called "timetable". Surely many people will wonder why I am a student and have not touched what students call a timetable for a long time. Of course, students or students all need it to see the class schedule, so that not a single morning is forgotten.</p>
            <p className='text-[18px] font-light tracking-wide leading-8'>In this article, I mean "timetable" or how to arrange time for each subject or something detailed on a calendar. Only now have I learned how to organize my time and divide each subject according to the school schedule. When we are young, healthy and studying and working, time is extremely important. If we know how to arrange and supplement it properly, we can check it, instead of wanting to learn something That's when you're comfortable saying: "Well, I guess I don't have time to learn" or a long course is found and then lament: "Haizz… This key is long world. Waste of time", you are trying to find a way to illustrate your laziness, you can spend a few hours playing games, surfing facebook, tiktok but spending a few minutes studying will not work. and try to be a busy person. That is, the time cannot be checked, so there will be a state at that time, doing a lot of things but there are times when there is an imbalance of not wanting to do anything, doing one thing is not wanting to do. Especially us in auto-learning time, the more we have to check it as something that helps us learn more interesting things.</p>
            <br />
            <p className='text-[18px] font-light tracking-wide leading-8'>However, I am not a virtual person, the kind of person who when seeing a tree branch reach out from the curb also makes me stunned in front of the reader. . Routine for me, in general, does not work, when Hanoi always makes me unpredictable when standing still.</p>
            <br />
            <p className='text-[18px] font-light tracking-wide leading-8'>Some apps and ways to help me regain my motivation to try to self-study and work through the stressful epidemic period (This is my thought to share, if you have a good way, please do so ) Please comment below to let me and everyone know : when we all move online. You know why when we learn in online schools are redesigned when we are self-taught? That's why we call it binding on everything for example: teachers or grades, etc.</p>
            <br />
            <p className='text-[18px] font-light tracking-wide leading-8'>Then:</p>
            <br />
            <p className='text-[18px] font-light tracking-wide leading-8'>Please watch an online course on the online learning site or youtube as a specialized subject in school and are learning online, the person who makes the video tutorial like my teacher will help me stay motivated. learn more.
            ...
            <br />
            <p className='text-[18px] font-light tracking-wide leading-8'>Google Calendar (Completely free and always syncs with multiple devices. How delicious without using :v)
            ...
            {blog.map((item, index) => (
                <div key={index} className="mt-4">
                    <div className="py-4 hover:border-slate-400">
                        <div className="flex flex-row text-center items-center">
                            <img className="w-12 h-12 rounded-full" src={Ellipse12} alt="" />
                            <div className="flex flex-col ml-2 items-start">
                                <h3 className='text-[black] text-[18px] font-medium'>Kim Lien</h3>
                        ...
                        <h2 className='text-[#003663] text-[24px] font-bold my-4'>Time and motivation</h2>
                        <p className='text-[18px] font-light tracking-wide leading-8'>Maybe it's been a long time since I've touched a thing called "timetable". Or more rustic,
